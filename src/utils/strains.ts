...
export const DEFAULT_STRAINS: Strain[] = [
  ...
  },
  {
    ...
    thcPercent: 0.15,
    terpenes: [
      { name: 'Limonene', percentage: 1.10, note: 'Bright citrus pastry sweetness' },
      { name: 'Myrcene', percentage: 0.86, note: 'Soft herbal dessert calm' },
      { name: 'beta-Caryophyllene', percentage: 0.54, note: 'Warm spice and peppered finish' },
    ],
    aromaNotes: 'Buttery waffle batter, candied citrus, and warm vanilla spice.',
    lineage: 'Dessert hybrid select phenotype',
    phenotypeAppearance: 'Dense frosted purple-green flower with milky trichomes and curling copper pistils.',
    floweringWeeks: 8,
    harvestWindow: 'Limited Drop',
  },
  {
    id: 'venom-runtz',
    name: 'Venom Runtz',
    ...
    thcPercent: 0.15,
    terpenes: [
      { name: 'Limonene', percentage: 1.14, note: 'Candy citrus brightness' },
      { name: 'Myrcene', percentage: 0.82, note: 'Soft fruity herbal ease' },
      { name: 'Linalool', percentage: 0.46, note: 'Creamy floral dessert finish' },
    ],
    aromaNotes: 'Fruity candy, lemon cream, and light vanilla spice.',
    lineage: 'Runtz dessert hybrid phenotype',
    phenotypeAppearance: 'Frosty light-green nug layered in milky trichomes with vivid orange pistils.',
    floweringWeeks: 8,
    harvestWindow: 'Limited Drop',
  },
  {
    ...
    thcPercent: 0.15,
    terpenes: [
      { name: 'Limonene', percentage: 1.08, note: 'Bright citrus cream' },
      { name: 'beta-Caryophyllene', percentage: 0.58, note: 'Warm artisanal spice' },
      { name: 'Myrcene', percentage: 0.80, note: 'Gentle earthy dessert calm' },
    ],
    aromaNotes: 'Citrus sherbet, sweet pastry, and a refined herbal finish.',
    lineage: 'L.A. select premium hybrid phenotype',
    phenotypeAppearance: 'Hand-held frosty nug with bright green calyxes, milky trichomes, and copper-orange pistils.',
    floweringWeeks: 8,
    harvestWindow: 'Limited Drop',
  },
];
